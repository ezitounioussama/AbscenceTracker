    ...
    <form action="./update.php" method="POST" class="mt-6 mb-0 space-y-4 rounded-lg p-8 w-[400px] md:shadow-2xl xl:shadow-2xl">
        ...
        <div>
            ...
            <div class="relative mt-1">
                <input type="text" id="seance" name="seance" value="<?= $seance['seance_name'] ?>" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="Enter seance" />
