...
<body>
    ...
    <table>
        ...
        // $result = $stmt->setFetchMode(PDO::FETCH_ASSOC);7
        ...
        foreach ($test as $key => $value) {
            ...
            echo "<td>$value[1]</td>";
            echo "<td>$value[2]</td>";
            echo "<td><a href='delete.php?id=$value[0]' class='underline cursor-pointer'>delete</a></td>";
            echo "<td><a href='update.php?id=$value[0]' class='underline cursor-pointer mx-5'>update</a></td>";
            echo '</tr>';
        }
                ...
                <div class="max-w-xl lg:max-w-3xl">
                    ...
                    <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                            <a href="students/index.html" class="inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
                                LOGIN
                            </a>
